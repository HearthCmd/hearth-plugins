...
hearth resource invoke my_drive sheet_update_range '{"spreadsheet_id":"<id>","range":"Sheet1!A2","values_json":"[[\"Item\",\"Qty\"],[\"Bolts\",40]]"}'
...
- **Deterministic — preferred once you've read the sheet.** `sheet_read_range`
  ...
  ```
  hearth resource invoke my_drive sheet_update_range '{"spreadsheet_id":"<id>","range":"Sheet1!A24","values_json":"[[\"New item\"]]"}'
  ```
- **Append with a range that overlaps the data** — give append a whole column or
  ...
  row:
  ```
  hearth resource invoke my_drive sheet_append_rows '{"spreadsheet_id":"<id>","range":"Sheet1!A:A","values_json":"[[\"New item\"]]"}'
  ```
